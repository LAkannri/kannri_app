...
def _do_autocall_many(job, entries, submit: bool):
    ...
    """
    return _do_autocall_pairs([(job, e) for e in entries], submit,
    ...
    def _pass(indexes):
        ...
        for i in indexes:
            ...
            try:
                ...
                continue
            if rows == 0:
                res[i] = {"ジョブ": jn, **_zero_result(sheet, name)}
                continue
            rounds, picked = groups.setdefault(job.get("call_robot") or DEFAULT_CALL_ROBOT, ([], []))
